...
syms X1;syms Y1;syms Z1;syms B1;syms B2;syms B3;syms B4;syms B5;syms B6;
rTpL=[x11 x12 x13 x14 x15 x16 x17 x18 x19,...
     ...
     z21 z22 z23 z24 z25 z26 z27 z28 z29,X1,Y1,Z1,B1,B2,B3,B4,B5,B6];
lim_x1=-X1-1000*B1;
lim_x2=X1-1000*B2;
lim_y1=-Y1-1000*B3;
lim_y2=Y1-1000*B4;
lim_z1=-Z1-1000*B5;
lim_z2=Z1-1000*B6;
lim_B=B1+B2+B3+B4+B5+B6;
lim_Quic=X1;
Aineq=[lim_x1 lim_x2 lim_y1 lim_y2 lim_z1 lim_z2 lim_B lim_Quic];
bineq=[-3 2 -5 0 -5 0 5 2.8];
AIneq=sym(zeros(8,63));
for i=1:8
    parfor j=1:1:63
        AIneq(i,j)=Aineq(i);
        for k=1:1:63
