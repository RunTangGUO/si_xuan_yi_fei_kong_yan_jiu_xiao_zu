...
syms B1;syms B2;syms B3;syms B4;syms B5;syms B6;
rTpL=[x11 x12 x13 x14 x15 x16 x17 x18 x19,...
     ...
     X21 X22 X23 X24 X25 X26 X27 X28 X29,...
     Y21 Y22 Y23 Y24 Y25 Y26 Y27 Y28 Y29,...
     Z21 Z22 Z23 Z24 Z25 Z26 Z27 Z28 Z29,X2,Y2,Z2,B1,B2,B3,B4,B5,B6];
lim_x1=X2-X1-100*B1;
lim_x2=X1-X2-100*B2;
lim_y1=Y2-Y1-100*B3;
lim_y2=Y1-Y2-100*B4;
lim_z1=Z2-Z1-100*B5;
lim_z2=Z1-Z2-100*B6;
EB=B1+B2+B3+B4+B5+B6;
Aineq=[lim_x1 lim_x2 lim_y1 lim_y2 lim_z1 lim_z2 EB];
bineq=[-0.5 -0.5 -0.5 -0.5 -0.4 -0.4 5];
