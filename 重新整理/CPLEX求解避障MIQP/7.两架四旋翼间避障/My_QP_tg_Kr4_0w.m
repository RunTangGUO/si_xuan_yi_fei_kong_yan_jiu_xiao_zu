...
rT11x=subs(rT1(1,1),{'x','T0','T1'},{1,0,1})-X1;
rT11y=subs(rT1(2,1),{'x','T0','T1'},{1,0,1})-Y1;
rT11z=subs(rT1(3,1),{'x','T0','T1'},{1,0,1})-Z1;
rT21x=subs(rT2(1,1),{'x','T1','T2'},{1,1,2})-X1;
rT21y=subs(rT2(2,1),{'x','T1','T2'},{1,1,2})-Y1;
rT21z=subs(rT2(3,1),{'x','T1','T2'},{1,1,2})-Z1;
