...
lim01=subs(rT1(1,1),{'x','T0','T1'},{0,0,1})-subs(rT1(1,1),{'x','T0','T1'},{1,0,1});
lim10=subs(rT1(1,1),{'x','T0','T1'},{1,0,1})-subs(rT1(1,1),{'x','T0','T1'},{0,0,1});
lim12=subs(rT1(1,1),{'x','T0','T1'},{1,0,1})-subs(rT2(1,1),{'x','T0','T1'},{1,0,1});
lim21=subs(rT2(1,1),{'x','T0','T1'},{1,0,1})-subs(rT1(1,1),{'x','T0','T1'},{1,0,1});
lim23=subs(rT2(1,1),{'x','T0','T1'},{1,0,1})-subs(rT3(1,1),{'x','T0','T1'},{1,0,1});
lim32=subs(rT3(1,1),{'x','T0','T1'},{1,0,1})-subs(rT2(1,1),{'x','T0','T1'},{1,0,1});
lim34=subs(rT3(1,1),{'x','T0','T1'},{1,0,1})-subs(rT4(1,1),{'x','T0','T1'},{1,0,1});
lim43=subs(rT4(1,1),{'x','T0','T1'},{1,0,1})-subs(rT3(1,1),{'x','T0','T1'},{1,0,1});
Aineq=[lim01 lim10 lim12 lim21 lim23 lim32 lim34 lim43];
bineq=[0.67 0.67 0.67 0.67 0.67 0.67 0.67 0.67];
