...
lim1_x1=-subs(rT1(1,1),{'x'},{0.4})-1000*B11;
lim1_x2=subs(rT1(1,1),{'x'},{0.4})-1000*B12;
lim1_y1=-subs(rT1(2,1),{'x'},{0.4})-1000*B13;
lim1_y2=subs(rT1(2,1),{'x'},{0.4})-1000*B14;
lim1_B=B11+B12+B13+B14;
lim01=subs(rT1(1,1),{'x','T0','T1'},{0,0,1})-subs(rT1(1,1),{'x','T0','T1'},{0.4,0,1});
lim10=subs(rT1(1,1),{'x','T0','T1'},{0.4,0,1})-subs(rT1(1,1),{'x','T0','T1'},{0,0,1});
lim12=subs(rT1(1,1),{'x','T0','T1'},{0.4,0,1})-subs(rT1(1,1),{'x','T0','T1'},{0.8,0,1});
lim21=subs(rT1(1,1),{'x','T0','T1'},{0.8,0,1})-subs(rT1(1,1),{'x','T0','T1'},{0.4,0,1});
lim23=subs(rT1(1,1),{'x','T0','T1'},{0.8,0,1})-subs(rT2(1,1),{'x','T0','T1'},{0.2,0,1});
lim32=subs(rT2(1,1),{'x','T0','T1'},{0.2,0,1})-subs(rT1(1,1),{'x','T0','T1'},{0.8,0,1});
lim2_x1=-subs(rT1(1,1),{'x','T0','T1'},{0.8,0,1})-1000*B21;
lim2_x2=subs(rT1(1,1),{'x','T0','T1'},{0.8,0,1})-1000*B22;
lim2_y1=-subs(rT1(2,1),{'x','T0','T1'},{0.8,0,1})-1000*B23;
lim2_y2=subs(rT1(2,1),{'x','T0','T1'},{0.8,0,1})-1000*B24;
lim2_B=B21+B22+B23+B24;
lim3_x1=-subs(rT2(1,1),{'x','T0','T1'},{0.2,0,1})-1000*B31;
lim3_x2=subs(rT2(1,1),{'x','T0','T1'},{0.2,0,1})-1000*B32;
lim3_y1=-subs(rT2(2,1),{'x','T0','T1'},{0.2,0,1})-1000*B33;
lim3_y2=subs(rT2(2,1),{'x','T0','T1'},{0.2,0,1})-1000*B34;
lim3_B=B31+B32+B33+B34;
lim34=subs(rT2(1,1),{'x','T0','T1'},{0.2,0,1})-subs(rT2(1,1),{'x','T0','T1'},{0.6,0,1});
lim43=subs(rT2(1,1),{'x','T0','T1'},{0.6,0,1})-subs(rT2(1,1),{'x','T0','T1'},{0.2,0,1});
