...
lim1_x1=-subs(rT1(1,1),{'x'},{0.5})-1000*B11;
lim1_x2=subs(rT1(1,1),{'x'},{0.5})-1000*B12;
lim1_y1=-subs(rT1(2,1),{'x'},{0.5})-1000*B13;
lim1_y2=subs(rT1(2,1),{'x'},{0.5})-1000*B14;
lim1_B=B11+B12+B13+B14;
lim01=subs(rT1(1,1),{'x','T0','T1'},{0,0,1})-subs(rT1(1,1),{'x','T0','T1'},{0.5,0,1});
lim10=subs(rT1(1,1),{'x','T0','T1'},{0.5,0,1})-subs(rT1(1,1),{'x','T0','T1'},{0,0,1});
lim12=subs(rT1(1,1),{'x','T0','T1'},{0.5,0,1})-subs(rT2(1,1),{'x','T0','T1'},{0,0,1});
lim21=subs(rT2(1,1),{'x','T0','T1'},{0,0,1})-subs(rT1(1,1),{'x','T0','T1'},{0.5,0,1});
lim23=subs(rT2(1,1),{'x','T0','T1'},{0,0,1})-subs(rT2(1,1),{'x','T0','T1'},{0.5,0,1});
lim32=subs(rT2(1,1),{'x','T0','T1'},{0.5,0,1})-subs(rT2(1,1),{'x','T0','T1'},{0,0,1});
lim2_x1=-subs(rT2(1,1),{'x','T0','T1'},{0,0,1})-1000*B21;
lim2_x2=subs(rT2(1,1),{'x','T0','T1'},{0,0,1})-1000*B22;
lim2_y1=-subs(rT2(2,1),{'x','T0','T1'},{0,0,1})-1000*B23;
lim2_y2=subs(rT2(2,1),{'x','T0','T1'},{0,0,1})-1000*B24;
lim2_B=B21+B22+B23+B24;
lim3_x1=-subs(rT2(1,1),{'x','T0','T1'},{0.5,0,1})-1000*B31;
lim3_x2=subs(rT2(1,1),{'x','T0','T1'},{0.5,0,1})-1000*B32;
lim3_y1=-subs(rT2(2,1),{'x','T0','T1'},{0.5,0,1})-1000*B33;
lim3_y2=subs(rT2(2,1),{'x','T0','T1'},{0.5,0,1})-1000*B34;
lim3_B=B31+B32+B33+B34;
lim34=subs(rT2(1,1),{'x','T0','T1'},{0.5,0,1})-subs(rT2(1,1),{'x','T0','T1'},{1,0,1});
lim43=subs(rT2(1,1),{'x','T0','T1'},{1,0,1})-subs(rT2(1,1),{'x','T0','T1'},{0.5,0,1});
% lim45=subs(rT2(1,1),{'x','T0','T1'},{0.6,0,1})-subs(rT2(1,1),{'x','T0','T1'},{1,0,1});
% lim54=subs(rT2(1,1),{'x','T0','T1'},{1,0,1})-subs(rT2(1,1),{'x','T0','T1'},{0.6,0,1});
% lim4_x1=-subs(rT2(1,1),{'x','T0','T1'},{0.6,0,1})-1000*B41;
% lim4_x2=subs(rT2(1,1),{'x','T0','T1'},{0.6,0,1})-1000*B42;
% lim4_y1=-subs(rT2(2,1),{'x','T0','T1'},{0.6,0,1})-1000*B43;
% lim4_y2=subs(rT2(2,1),{'x','T0','T1'},{0.6,0,1})-1000*B44;
% lim4_B=B41+B42+B43+B44;
Aineq=[lim1_x1 lim1_x2 lim1_y1 lim1_y2 lim2_x1 lim2_x2 lim2_y1 lim2_y2 lim3_x1 lim3_x2 lim3_y1 lim3_y2 lim01 lim10 lim12 lim21 lim23 lim32 lim34 lim43 lim1_B lim2_B lim3_B];
