...
lim1_x1=-subs(rT1(1,1),{'x'},{0.7})-1000*B11;
lim1_x2=subs(rT1(1,1),{'x'},{0.7})-1000*B12;
lim1_y1=-subs(rT1(2,1),{'x'},{0.7})-1000*B13;
lim1_y2=subs(rT1(2,1),{'x'},{0.7})-1000*B14;
lim1_B=B11+B12+B13+B14;
lim01=subs(rT1(1,1),{'x','T0','T1'},{0,0,1})-subs(rT1(1,1),{'x','T0','T1'},{0.7,0,1});
lim10=subs(rT1(1,1),{'x','T0','T1'},{0.7,0,1})-subs(rT1(1,1),{'x','T0','T1'},{0,0,1});
lim12=subs(rT1(1,1),{'x','T0','T1'},{0.7,0,1})-subs(rT2(1,1),{'x','T0','T1'},{0.4,0,1});
lim21=subs(rT2(1,1),{'x','T0','T1'},{0.4,0,1})-subs(rT1(1,1),{'x','T0','T1'},{0.7,0,1});
lim23=subs(rT2(1,1),{'x','T0','T1'},{0.4,0,1})-subs(rT2(1,1),{'x','T0','T1'},{1,0,1});
lim32=subs(rT2(1,1),{'x','T0','T1'},{0.4,0,1})-subs(rT2(1,1),{'x','T0','T1'},{0.4,0,1});
lim2_x1=-subs(rT2(1,1),{'x','T0','T1'},{0.4,0,1})-1000*B21;
lim2_x2=subs(rT2(1,1),{'x','T0','T1'},{0.4,0,1})-1000*B22;
lim2_y1=-subs(rT2(2,1),{'x','T0','T1'},{0.4,0,1})-1000*B23;
lim2_y2=subs(rT2(2,1),{'x','T0','T1'},{0.4,0,1})-1000*B24;
