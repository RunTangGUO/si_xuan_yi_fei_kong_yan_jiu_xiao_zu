...
dx19=limit(diff(rT8(1,1),1),x,8);
dx29=limit(diff(rT8(1,1),2),x,8);
dx39=limit(diff(rT8(1,1),3),x,8);
dx49=limit(diff(rT8(1,1),4),x,8);
dy19=limit(diff(rT8(2,1),1),x,8);
dy29=limit(diff(rT8(2,1),2),x,8);
dy39=limit(diff(rT8(2,1),3),x,8);
dy49=limit(diff(rT8(2,1),4),x,8);
dz19=limit(diff(rT8(3,1),1),x,8);
dz29=limit(diff(rT8(3,1),2),x,8);
dz39=limit(diff(rT8(3,1),3),x,8);
dz49=limit(diff(rT8(3,1),4),x,8);
%转折点处导数连续
