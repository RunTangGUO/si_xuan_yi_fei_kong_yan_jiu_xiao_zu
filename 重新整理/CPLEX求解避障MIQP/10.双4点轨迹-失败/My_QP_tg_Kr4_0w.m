...
rT31x=subs(rT3(1,1),{'x'},{2});
rT31y=subs(rT3(2,1),{'x'},{2});
rT31z=subs(rT3(3,1),{'x'},{2});
rT32x=subs(rT3(1,1),{'x'},{3});
rT32y=subs(rT3(2,1),{'x'},{3});
rT32z=subs(rT3(3,1),{'x'},{3});
...
dx14=limit(diff(rT4(1,1),1),x,4);
dx24=limit(diff(rT4(1,1),2),x,4);
dx34=limit(diff(rT4(1,1),3),x,4);
dx44=limit(diff(rT4(1,1),4),x,4);
dy14=limit(diff(rT4(2,1),1),x,4);
dy24=limit(diff(rT4(2,1),2),x,4);
dy34=limit(diff(rT4(2,1),3),x,4);
dy44=limit(diff(rT4(2,1),4),x,4);
dz14=limit(diff(rT4(3,1),1),x,4);
dz24=limit(diff(rT4(3,1),2),x,4);
dz34=limit(diff(rT4(3,1),3),x,4);
dz44=limit(diff(rT4(3,1),4),x,4);
%转折点处导数连续
...
STP=[rT10x rT10y rT10z rT11x rT11y rT11z rT21x rT21y rT21z rT22x rT22y rT22z,...
    ...
    dx14 dx24 dx34 dx44 dy14 dy24 dy34 dy44 dz14 dz24 dz34 dz44 ,...
    dx1x2 dy1y2 dz1z2,...
    dx2x3 dy2y3 dz2z3,...
    dx3x4 dy3y4 dz3z4];
