...
N010=-(subs(rT1(1,1),{'x',T0,T1},{0,0,1})+M*b010);
N011=-(subs(rT1(1,1),{'x',T0,T1},{0.2,0,1})+M*b011);
N012=-(subs(rT1(1,1),{'x',T0,T1},{0.4,0,1})+M*b012);
N013=-(subs(rT1(1,1),{'x',T0,T1},{0.6,0,1})+M*b013);
N014=-(subs(rT1(1,1),{'x',T0,T1},{0.8,0,1})+M*b014);
N015=-(subs(rT1(1,1),{'x',T0,T1},{1,0,1})+M*b015);
N030=-(subs(rT1(2,1),{'x',T0,T1},{0,0,1})+M*b030);
N031=-(subs(rT1(2,1),{'x',T0,T1},{0.2,0,1})+M*b031);
N032=-(subs(rT1(2,1),{'x',T0,T1},{0.4,0,1})+M*b032);
N033=-(subs(rT1(2,1),{'x',T0,T1},{0.6,0,1})+M*b033);
N034=-(subs(rT1(2,1),{'x',T0,T1},{0.8,0,1})+M*b034);
N035=-(subs(rT1(2,1),{'x',T0,T1},{1,0,1})+M*b035);
N050=-(subs(rT1(3,1),{'x',T0,T1},{0,0,1})+M*b050);
N051=-(subs(rT1(3,1),{'x',T0,T1},{0.2,0,1})+M*b051);
N052=-(subs(rT1(3,1),{'x',T0,T1},{0.4,0,1})+M*b052);
N053=-(subs(rT1(3,1),{'x',T0,T1},{0.6,0,1})+M*b053);
N054=-(subs(rT1(3,1),{'x',T0,T1},{0.8,0,1})+M*b054);
N055=-(subs(rT1(3,1),{'x',T0,T1},{1,0,1})+M*b055);
N020=-(subs(rT1(1,1),{'x',T0,T1},{0,0,1})*Obs_n2(1,1))-M*b020;
N021=-(subs(rT1(1,1),{'x',T0,T1},{0.2,0,1})*Obs_n2(1,1))-M*b021;
N022=-(subs(rT1(1,1),{'x',T0,T1},{0.4,0,1})*Obs_n2(1,1))-M*b022;
N023=-(subs(rT1(1,1),{'x',T0,T1},{0.6,0,1})*Obs_n2(1,1))-M*b023;
N024=-(subs(rT1(1,1),{'x',T0,T1},{0.8,0,1})*Obs_n2(1,1))-M*b024;
N025=-(subs(rT1(1,1),{'x',T0,T1},{1,0,1})*Obs_n2(1,1))-M*b025;
N040=-(subs(rT1(2,1),{'x',T0,T1},{0,0,1})*Obs_n4(1,2))-M*b040;
N041=-(subs(rT1(2,1),{'x',T0,T1},{0.2,0,1})*Obs_n4(1,2))-M*b041;
N042=-(subs(rT1(2,1),{'x',T0,T1},{0.4,0,1})*Obs_n4(1,2))-M*b042;
N043=-(subs(rT1(2,1),{'x',T0,T1},{0.6,0,1})*Obs_n4(1,2))-M*b043;
N044=-(subs(rT1(2,1),{'x',T0,T1},{0.8,0,1})*Obs_n4(1,2))-M*b044;
N045=-(subs(rT1(2,1),{'x',T0,T1},{1,0,1})*Obs_n4(1,2))-M*b045;
N060=-(subs(rT1(3,1),{'x',T0,T1},{0,0,1})*Obs_n6(1,3))-M*b060;
N061=-(subs(rT1(3,1),{'x',T0,T1},{0.2,0,1})*Obs_n6(1,3))-M*b061;
N062=-(subs(rT1(3,1),{'x',T0,T1},{0.4,0,1})*Obs_n6(1,3))-M*b062;
N063=-(subs(rT1(3,1),{'x',T0,T1},{0.6,0,1})*Obs_n6(1,3))-M*b063;
N064=-(subs(rT1(3,1),{'x',T0,T1},{0.8,0,1})*Obs_n6(1,3))-M*b064;
N065=-(subs(rT1(3,1),{'x',T0,T1},{1,0,1})*Obs_n6(1,3))-M*b065;
%关于障碍物的约束
% for i=0:N-1
%     for j=1:F
%         for k=0:K
...
save QP_model_2wayponit_&_Obstacle_easy