...
N039=subs(rT1(2,1),{'x',T0,T1},{0.6,0,1});
N053=-(subs(rT1(3,1),{'x',T0,T1},{0.6,0,1}));
N059=subs(rT1(3,1),{'x',T0,T1},{0.6,0,1});
N013=-(subs(rT1(1,1),{'x',T0,T1},{0.6,0,1}));
N019=subs(rT1(1,1),{'x',T0,T1},{0.6,0,1});
...
STa=[N033 N039 N013 N019 N053 N059];
% STb=[-5 6 -2 3];
